...
const UserApproved = () => {
  ...
  return (
    <SafeAreaView style={tw`flex-1 px-2 py-10 bg-gray-100`}>
      {/* Header */}
      <HeaderScreens />
      ...
      <ScrollView style={tw`flex w-full`}>
        ...
        >
          This will enable us complete checks on your background and get your
        ...
        <TouchableOpacity
          onPress={() =>
            router.push(
              "/(employees)/user_account/personal-info/identity-verification/image-upload"
            )
          }
        ...
        <TouchableOpacity
          onPress={() =>
            router.push(
              "/(employees)/user_account/personal-info/identity-verification/id-card-upload"
            )
          }
        ...
        >
          <View style={tw`flex flex-row gap-3 items-start`}>
            ...
            <View style={tw`flex flex-col`}>
              <Text style={tw`text-base text-stone-900 font-bold`}>
                ID Card
              </Text>
        ...
        <TouchableOpacity
          onPress={() =>
            router.push(
              "/(employees)/user_account/personal-info/identity-verification/passport-upload"
            )
          }
          style={tw`flex-row items-center justify-between py-2`}
        >
        ...
        <TouchableOpacity
          onPress={() =>
            router.push(
              "/(employees)/user_account/personal-info/identity-verification/certificate-upload"
            )
          }
          style={tw`flex-row items-center justify-between py-2`}
        >
