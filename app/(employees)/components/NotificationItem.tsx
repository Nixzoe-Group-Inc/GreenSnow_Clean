...
export const NotificationItem: React.FC<NotificationDetailsProps> = ({ title , message, iconUrl }) => {
  return (
    <View style={tw`flex flex-col justify-center items-center py-1.5 mt-2 text-2xl tracking-tighter rounded-xl bg-zinc-300 max-w-[356px] text-zinc-800`}>
      <View style={tw`flex flex-row justify-between items-center w-full`}>
        ...
        />
        <View style={tw`self-stretch px-1 py-0.5 my-auto min-w-[240px] w-[260px]`}>
