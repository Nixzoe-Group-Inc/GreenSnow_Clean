  ...
  return (
    <View style={tw`flex-1 pt-10 bg-gray-100 p-1 items-center`}>
      ...
      <ScrollView contentContainerStyle={tw`items-center`}>
        {/* Description */}
        <Text style={tw`text-gray-600 mt-5 mb-7`}>{description}</Text>
        ...
        {showActionButtons ? (
          ...
          <View style={tw`flex justify-around`}>
            ...
            <ActionButton
              ...
              buttonStyle="bg-red-500 mt-2 w-[327px] mb-9"
              isEnabled={true}
              label="Disapprove"
            />
          </View>
          ...
          <View style={tw`flex justify-around`}>
            <View
              style={tw`flex flex-col self-start px-16 py-4 mt-1 w-full rounded-xl max-w-[327px] items-center w-[300px] bg-stone-300`}
            >
              {approved ? (
                <Text
                  style={tw`text-xl font-semibold tracking-tight text-center text-zinc-400`}
                >
                  Approved
                </Text>
              ) : (
