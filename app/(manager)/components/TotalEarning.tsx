...
export const TotalEarnings: React.FC<EarningProps> = ({ totalEarnings }) => {
  return (
    <View style={tw`flex flex-col justify-center items-start mt-3 text-center`}>
      <View
        style={tw`text-xl font-extrabold tracking-tight leading-none text-stone-900`}
      >
        <Text
          style={tw`text-xl font-extrabold leading-none text-center text-stone-900 tracking-wide`}
        >
          ${totalEarnings}
        </Text>
      </View>
